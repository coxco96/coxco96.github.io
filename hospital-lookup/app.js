...
function getDistance(searchResult, searchName) {
    ...
    d3.json("https://raw.githubusercontent.com/coxco96/nearest-hospital-lookup/main/data/feature-collection.json").then(data => {
        hospitals = data;
        ...
        results.innerHTML = `Nearest hospital: <strong>${name}</strong> <br><em>${formattedDistance} miles away</em>`
    })
}
